...
3. RPG.lua -A simple RPG game with 3 characters, each with two abilities and a single fighting style.
4. teste.lua -A simple code to set a password, lock the system if the password is entered incorrectly 3 times, and allow access if the correct password is entered.
5. Separador.lua -A code that separates a sequence into even and odd numbers.
